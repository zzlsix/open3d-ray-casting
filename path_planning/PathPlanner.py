...
class PathPlanner:
    ...
    def plan_path(self, start_point, end_point,
        ...
        try:
            ...
            if visualize:
                # 尽管没有路径，但仍然可视化网格和两点
                self.visualizer.visualize_no_path(self.mesh, start_vertex, end_vertex, connected_components, vertices)
        ...
        if len(path_indices) > 2:
            print("平滑路径...")
            final_path = self.path_smoother.smooth_path(path_vertices)
        else:
